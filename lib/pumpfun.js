        ...
        for (let attempt = 1; attempt <= 3; attempt++) {
            try {
                ...
                if (attempt < 3) {
                    ...
                    // Token was created successfully — fee sharing can be set up later
                    console.error('[REAL] Fee sharing failed after 3 attempts. Token still launched successfully.');
                }
            }
        }
    }
