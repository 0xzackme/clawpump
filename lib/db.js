/**
 * PostgreSQL data layer for ClawDotPump.
 *
...
const INIT_SQL = `
    ...
    CREATE TABLE IF NOT EXISTS tokens (
        ...
        creator_share_pct REAL DEFAULT 65,
        platform_share_pct REAL DEFAULT 35,
    ...
    try {
        ...
        await client.query(
            ...
            [
                ...
                token.creatorSharePct || 65, token.platformSharePct || 35,
