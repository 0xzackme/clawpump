...
const stmts = {
    ...
    getRecentLaunchByAgent: db.prepare(`
        SELECT * FROM tokens WHERE agentId = ? 
...
export function getRecentLaunchByAgent(agentId) {
    return stmts.getRecentLaunchByAgent.get(agentId) || null;
}
